DROP DATABASE IF EXISTS WarpSec;
CREATE DATABASE WarpSec CHARACTER SET utf8 COLLATE utf8_general_ci;
...
INSERT INTO Parameters (WarpEnvironment, WarpSalt, WarpKey, WarpValue) VALUES ('TEST_US', 'NO_SALT', 'resourceCode', 'en-us');
